...
CKEDITOR.dialog.add("colordialog", function(x) {
    ...
    function A(a) {
        ...
        var c = !/mouse/.test(a.name),
            b = a.data.getTarget(),
            k;
        "td" == b.getName() && (k = b.getChild(0).getHtml()) && (q(a), c ? d = b : B = b, c && b.addClass(D(k) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"), r(k))
    }
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        html: "\x3cspan\x3e" + g.highlight + '\x3c/span\x3e\x3cdiv id\x3d"' +
                            t + '" style\x3d"border: 1px solid; height: 74px; width:100%;"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + u + '"\x3e\x26nbsp;\x3c/div\x3e\x3cspan\x3e HEX \x3c/span\x3e\x3cdiv id\x3d"' + n + '" style\x3d"border: 1px solid; height: 20px; width: 74px;"\x3e\x3c/div\x3e'
                    },
                        {
                        type: "text",
                        // placeholder:"rgb(255,55,55)",
                        label: "Example: rgb(255,55,55)" ,
                        value:"Example: rgb(255,55,55",
