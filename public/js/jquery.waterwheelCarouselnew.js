...
(function($) {
        ...
        function setupCarousel() {
            ...
            if (options.horizon === 0) {
                if (options.orientation === 'horizontal') {
                    options.horizon = data.containerHeight / 3;
                } else {
    ...
    $.fn.waterwheelCarousel.defaults = {
        ...
        activeClassName: 'active_text', // the name of the class given to the current item in the center
        ...
        forcedImageWidth: 290, // specify width of all images; otherwise the carousel tries to calculate it
        forcedImageHeight: 306, // specify height of all images; otherwise the carousel tries to calculate it
