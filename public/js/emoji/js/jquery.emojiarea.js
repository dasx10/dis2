  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    this.$editor.attr({
      ...
      'onkeyup':'send_message(this,event)'
    });
    ...
    $textarea.after("<img class='emoji-picker-icon emoji-picker' src='/public/img/admin/ico_smile.png' data-id='" + id + "' data-type='picker' ></img>");
