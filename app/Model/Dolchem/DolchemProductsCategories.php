...
class DolchemProductsCategories extends Model{
    protected $table = 'dolchem_products_categories';
    protected $dateFormat = 'U';
    protected $hidden = ['created_at','updated_at'];
    protected $fillable = ['id','photo_url','photo_url_hover','title','position'];
