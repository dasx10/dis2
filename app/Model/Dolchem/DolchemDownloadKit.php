...
class DolchemDownloadKit extends Model{
    protected $table = 'dolchem_download_kit';
    protected $dateFormat = 'U';
    protected $hidden = ['created_at','updated_at'];
    protected $fillable = ['id','photo_url','photo_url_hover','link','title','position'];
     ...
     * @return mixed
     */
    public function get_link_by_slide_id($slide_id){
        return self::where('id','=',$slide_id)->value('link');
    }
     ...
     * @return mixed
     */
    public function get_photo_url_hover_by_slide_id($slide_id){
        return self::where('id','=',$slide_id)->value('photo_url_hover');
    }
    ...
    public function delete_slide($slide_id){
        ...
        Photos::delete_photo($slide_data->photo_url_hover);
        Photos::delete_photo($slide_data->link);
