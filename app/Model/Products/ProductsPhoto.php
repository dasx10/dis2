...
class ProductsPhoto extends Model{
     ...
     * @return mixed
     */
    public function get_photos_by_products_id($products_id){
    ...
    public function delete_files($products_id){
        $photos = self::get_photos_by_products_id($products_id);
    ...
    public function delete_photo_by_id($photos_id){
        $photos = self::where('id','=',$photos_id)->first();
