                ...
                <div class="card box-shadow">
                    <div class="card-header" style="padding-top:0.9375rem;padding-bottom: 0.9375rem;border-radius: 0">
                        <h5 class="d-flex align-items-center" style="margin-bottom: 0;font-size: 1.125rem;">
                            ...
                            <a href="/panel/admin/catalog" style="color:#4c6897;">Catalogue</a> <span style="padding-right:5px;padding-left:5px;">|</span> <span>Edit product</span></h5>
                    </div>
                    <div class="card-block">
                        <form class="addProd">
                            <input type="hidden" class="itemeach" name="products_id" value="{{$products_data->id}}">
                            <div class="row">
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <div class="col  form-group" style="margin-bottom: .97rem;">
                                        <input maxlength="75" type="text" name="product_name" value="{{$products_data->product_name}}" class="itemeach form-control check_space" placeholder="*Product Name" required>
                                    </div>
                                    <div class="col  form-group" style="margin-bottom: .97rem;">
                                        <input type="text" name="product_code" value="{{$products_data->product_code}}" class="itemeach form-control check_space" placeholder="*Product Code (Capital letters of product name)" required>
                                    </div>
                                    <div class="col  form-group">
                                        <input type="file"   name="photo_files[]" accept="image/png, image/jpeg" id="photo_files" class="inputfile inputfile-6" data-multiple-caption="{count} files selected" multiple />
                                    ...
                                    <div class="col  form-group" style="margin-bottom: .97rem;">
                                        <input type="text" name="specification" value="{{$products_data->specification}}" class="itemeach form-control check_space" placeholder="*Specification" required>
                                    </div>
                                    <div class="col  form-group" style="margin-bottom: .97rem;">
                                        <input type="text" onkeyup="check_cas(this)" name="cas" value="{{$products_data->cas}}" class="itemeach form-control check_space" placeholder="*CAS" required>
                                    </div>
                                    <div class="col  form-group">
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <input type="hidden" name="shipping_class" value="{{$products_data->shipping_class}}" class="itemeach">
                                        {{--<input type="text" name="shipping_class" class="itemeach form-control" placeholder="Shipping Class">--}}
                                    </div>
                                    <div class="col form-group">
                                        <input required type="text" name="type_of_packaging1" value="{{$products_data->type_of_packaging1}}" class="itemeach form-control check_space" placeholder="*Type of the Packaging 1">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return requiredInput1(this);" onchange="return requiredInput1(this);" name="type_of_packaging2" value="{{$products_data->type_of_packaging2}}" class="itemeach form-control check_space" placeholder="Type of the packaging 2">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return requiredInput2(this);" onchange="return requiredInput2(this);" name="type_of_packaging3" value="{{$products_data->type_of_packaging3}}" class="itemeach form-control check_space" placeholder="Type of the packaging 3">
                                    </div>
                                    {{--<div class="col  form-group">--}}
                                        {{--<input type="text" name="type_of_packaging1_price" value="{{$products_data->type_of_packaging1_price}}" class="itemeach form-control check_space" placeholder="Type of the packaging 1 Price">--}}
                                    {{--</div>--}}
                                    {{--<div class="col  form-group">--}}
                                        {{--<input type="text" name="type_of_packaging2_price" value="{{$products_data->type_of_packaging2_price}}" class="itemeach form-control check_space" placeholder="Type of the packaging 2 Price">--}}
                                    {{--</div>--}}
                                    {{--<div class="col  form-group">--}}
                                        {{--<input type="text" name="type_of_packaging3_price" value="{{$products_data->type_of_packaging3_price}}" class="itemeach form-control check_space" placeholder="Type of the packaging 3 Price">--}}
                                    {{--</div>--}}
                                    {{--<div class="col  form-group">--}}
                                        <input type="hidden" name="pallet_without_pallet" value="{{$products_data->pallet_without_pallet}}" class="itemeach form-control check_space" placeholder="*Pallet /Without pallet">
                                    {{--</div>--}}
                                    <div class="col form-group">
                                        <div class="dropdown" style="width:100%;">
                                    ...
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" value="{{$products_data->pallet_capacity_for_packaging_type_1}}" required name="pallet_capacity_for_packaging_type_1" class="itemeach form-control check_space" placeholder="Pallet capacity of packaging 1">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" value="{{$products_data->pallet_capacity_for_packaging_type_2}}" name="pallet_capacity_for_packaging_type_2" class="itemeach form-control check_space" placeholder="Pallet capacity of packaging 2">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" value="{{$products_data->pallet_capacity_for_packaging_type_3}}" name="pallet_capacity_for_packaging_type_3" class="itemeach form-control check_space" placeholder="Pallet capacity of packaging 3">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" name="" class="itemeach form-control check_space" placeholder="Pallet L*W*H (m)">
                                    </div>
                                    {{--<div class="col  form-group">--}}
                                        {{--<input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging1}}" name="price_prod_plus_packaging1"  class="itemeach form-control check_space" placeholder="*Price of the product + packaging 1" required onkeyup="return check(this);" onchange="return check(this);">--}}
                                    {{--</div>--}}
                                    {{--<div class="col  form-group">--}}
                                        {{--<input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging2}}" name="price_prod_plus_packaging2"  class="itemeach form-control check_space" placeholder="Price of the product + packaging 2" onkeyup="return check(this);" onchange="return check(this);">--}}
                                    {{--</div>--}}
                                    {{--<div class="col  form-group">--}}
                                        {{--<input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging3}}" name="price_prod_plus_packaging3"  class="itemeach form-control check_space" placeholder="Price of the product + packaging 3" onkeyup="return check(this);" onchange="return check(this);">--}}
                                    {{--</div>--}}
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_1_1}}" name="moc_1_1"  class="itemeach form-control check_space" placeholder="*MOQ 1 for the packaging 1" required onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_1_2}}" name="moc_1_2"  class="itemeach form-control check_space" placeholder="MOQ 1 for the packaging 2"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_1_3}}" name="moc_1_3"  class="itemeach form-control check_space" placeholder="MOQ 1 for the packaging 3"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_2_1}}" name="moc_2_1"  class="itemeach form-control check_space" placeholder="*MOQ 2 for the packaging 1" required onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_2_2}}" name="moc_2_2"  class="itemeach form-control check_space" placeholder="MOQ 2 for the packaging 2"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_2_3}}" name="moc_2_3"  class="itemeach form-control check_space" placeholder="MOQ 2 for the packaging 3"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_3_1}}" name="moc_3_1"  class="itemeach form-control check_space" placeholder="*MOQ 3 for the packaging 1" required onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_3_2}}" name="moc_3_2"  class="itemeach form-control check_space" placeholder="MOQ 3 for the packaging 2"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->moc_3_3}}" name="moc_3_3"  class="itemeach form-control check_space" placeholder="MOQ 3 for the packaging 3"  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging1}}" name="price_prod_plus_packaging1"  class="itemeach form-control check_space" placeholder="*Price of Product - Pack 1 MOQ1" required onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                    ...
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging2}}" name="price_prod_plus_packaging2"  class="itemeach form-control check_space" placeholder="*Price of Product - Pack 1 MOQ2" required  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                    ...
                                    <div class="col  form-group">
                                        <input maxlength="15" type="text" value="{{$products_data->price_prod_plus_packaging3}}" name="price_prod_plus_packaging3"  class="itemeach form-control check_space" placeholder="*Price of Product - Pack 1 MOQ3" required  onkeyup="return check(this);" onchange="return check(this);">
                                    </div>
                                    <div class="col  form-group">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging1_wp" value="{{$products_data->lwh_packaging1_wp}}" class="itemeach form-control check_space" placeholder="*L * W * H of the packaging 1 (m)" required >
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging1_p" value="{{$products_data->lwh_packaging1_p}}" class="itemeach form-control check_space" placeholder="L * W * H of the packaging 1 on pallet (m)">
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging2_wp" value="{{$products_data->lwh_packaging2_wp}}" class="itemeach form-control check_space" placeholder="L * W * H of the packaging 2 (m)" >
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging2_p" value="{{$products_data->lwh_packaging2_p}}" class="itemeach form-control check_space" placeholder="L * W * H of the packaging 2 on pallet (m)" >
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging3_wp" value="{{$products_data->lwh_packaging3_wp}}" class="itemeach form-control check_space" placeholder="L * W * H of the packaging 3 (m)"  >
                                    </div>
                                    <div class="col  form-group">
                                        <input type="text" onkeyup="validateWHL(this)" name="lwh_packaging3_p" value="{{$products_data->lwh_packaging3_p}}" class="itemeach form-control check_space" placeholder="L * W * H of the packaging 3 on pallet (m)" >
                                    </div>
                                    <div class="col form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" class="itemeach form-control check_space" placeholder="Packaging 1 Net Weight">
                                    </div>
                                    <div class="col form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" class="itemeach form-control check_space" placeholder="Packaging 2 Net Weight">
                                    </div>
                                    <div class="col form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" class="itemeach form-control check_space" placeholder="Packaging 3 Net Weight">
                                    </div>
                                    <div class="col form-group">
                                        <input type="text" onkeyup="return check(this);" onchange="return check(this);" class="itemeach form-control check_space" placeholder="Pallet Weight">
                                    </div>
                                    <div class="col form-group">
                                        <input type="text"  name="loading_port" value="{{$products_data->loading_port}}" class="itemeach form-control check_space" placeholder="*Loading Port 1" required>
                                    </div>
                                    {{--<div class="col form-group">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="col form-group">--}}
                                        {{--<input type="text" name="loading_port" value="{{$products_data->loading_port}}" class="itemeach form-control check_space" placeholder="*Loading Port" required>--}}
                                    {{--</div>--}}
                                    <div class="col form-group">
                                        <input type="text" name="restrictions" value="{{$products_data->restrictions}}" class="itemeach form-control check_space" placeholder="Restrictions">
                                    </div>
                                    <div class="col form-group" style="margin-bottom: .5rem;position:relative;">
                                        <textarea class="itemeach form-control"  name="descr" id="descr" cols="20" rows="7" required style="height:150px; resize: none;">{{$products_data->descr}}</textarea>
                                        <span class="fixed_description">*Aplication</span>
                                    </div>
                                    <div class="col form-group">
                                        <input type="text" name="fcl"  value="{{$products_data->fcl}}" class="itemeach form-control check_space" placeholder="Information of FCL quantity (with/without pallet) ">
                                    </div>
                                    ...
                                    <input type="hidden" class="itemeach" name="category" value="{{$products_data->category}}">
                                    <input type="hidden" class="itemeach" name="brand" value="{{$products_data->brand}}">
                                    <div class="col form-group">
                                    ...
                                    {{--<div class="col form-group">--}}
                                    {{--<input required type="file"  name="pdf_file[]" accept="application/pdf" class="inputfile inputfile-6 doc_files" data-multiple-caption="{count} files selected"/>--}}
                                    {{--<label class="form-control">--}}
                                    {{--<span style="font-size: 1.125rem;padding-left: 0.75rem;padding-top: 0.9375rem;">PDF files only</span>--}}
                                    {{--<strong>...</strong>--}}
                                    {{--</label>--}}
                                    {{--</div>--}}
                                    <div class="doc_block">
                                    ...
                                    <div class="col form-group d-flex align-items-center">
                                        @foreach($documents as $key => $document)
                                            <div class="col-6 text-center">
                                                @if(strpos($document->filename,'.tds'))
                                                    <img class="img-fluid" src="/public/img/TDS.png" alt="">
                                                @elseif(strpos($document->filename,'.msds'))
                                                    <img class="img-fluid" src="/public/img/MSDS.png" alt="">
                                                @else
                                                    <img class="img-fluid" src="/public/img/pdf-download.png" alt="">
                                                @endif
                                                <h6><a class="special_color" href="{{$document->filename}}" download>
                                                        <?php
                                ...
                                <div class="col-12 text-center">
                                    <button class="btn_page btn_submit"><span>Edit</span></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        $('.select_name_brand').html('{{$products_data->brand}}');
        function set_brand(a) {
            $('input[name="brand"]').val($(a).html());
            $('.select_name_brand').html($(a).html());
        }

        $('.select_p_wp_brand').html('{{$products_data->pallet_without_pallet}}');
        ...
        $('.select_class_brand').html('{{$products_data->shipping_class}}');
        function setClass(a) {
            $('.select_class_brand').html(a);
            $('input[name="shipping_class"]').val(a);
        }

        $('.select_name_category').html('{{$products_data->category}}');
        ...
        $('form.addProd').on('submit',function(e){
            if (parseInt($('input[name="moc_1_1"]').val()) > parseInt($('input[name="moc_3_1"]').val())) {
                sweet_modal('MOQ 3 for the packaging 1 bigger then MOQ 1 for the packaging 1','error',4000);
                return false;
            }

            if (parseInt($('input[name="moc_1_1"]').val()) > parseInt($('input[name="moc_2_1"]').val())) {
                sweet_modal('MOQ 1 for the packaging 1 bigger then MOQ 2 for the packaging 1','error',4000);
                return false;
            }

            if (parseInt($('input[name="moc_2_1"]').val()) > parseInt($('input[name="moc_3_1"]').val())) {
                sweet_modal('MOQ 2 for the packaging 1 bigger then MOQ 3 for the packaging 1','error',4000);
                return false;
            }
            e.preventDefault();
            ...
            xhr.open('POST', '/api/admin/update_product', true);
            xhr.onload = function() {
