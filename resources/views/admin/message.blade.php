        ...
        <div class="container-fluid main_container_fluid">
            ...
            <div class="row" style="    background-color: #f0f0f0;">
                <div class="col-12 col-md-9 form-group">
                    ...
                    <span style="border-radius:0px 0.5rem 0.5rem 0px;background-color:#f2f2f2;border:0.125rem solid #aab4bc!important;border-left:none!important;width: 3.5625rem;
   height: 3.6875rem;">
                        <i class="fa fa-search" aria-hidden="true" style="color: #aab4bc;font-size: 1.3rem;margin-top: 1.1rem;margin-left: 1rem;"></i>
                    </span>
                </div>
                <div class="d-flex col-12 col-md-3 justify-content-md-end form-group">
                    <button class="btn_page" data-toggle="modal" data-target="#myModal_start_new_chat">Start New Chat</button>
                </div>
            </div>
                    ...
                    <table class="table">
                        ...
                        @foreach($exists_chats as $chat)
                                <tr style="border-bottom: 1px solid #e5e5e5;">
                                    ...
                                    @else
                                        <td><p onclick='location.href="/panel/admin/chat/{{$chat->id}}"' style="cursor: pointer;" class="m-0"><b>{{$chat->full_name}}</b></p>
                                    @endif
                                    ...
                                    <td class="text-center" style="width:10%;">
                                        <button onclick='location.href="/panel/admin/chat/{{$chat->id}}"' class="btn_green btn_submit"><img src="/public/img/admin/ico_msg.png" alt="" style="width:0.6875rem;height:0.6875rem;"></button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header RalewaySemiBold">
                        <h4 class="modal-title" id="myModalLabel">Start new Chat with...</h4>
                                    ...
                                    @foreach($new_chats as $admin)
                                            <tr style="border-top: 0.0625rem solid #e5e5e5;">
                                                ...
                                                <td class="text-center" style="width:15%;">
                                                    <button onclick="create_chat('{{$admin->users_id}}','{{$admin->type_acc}}')" class="btn_page btn_submit" style="width:12.5rem;height:2.1875rem;font-size:1.125rem;">Start Chat</button>
                                                </td>
                                            </tr>
                                    @endforeach
                                </tbody>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success == true) {
                            ...
                            setTimeout(function () {
                                window.location = '/panel/admin/messages';
                            }, 1000);
                        } else {
