        ...
        <div class="container-fluid main_container_fluid">
            <div class="card box-shadow">
              <div class="card-header" style="padding-top:  0.9375rem;padding-bottom: 0.9375rem;border-radius: 0;">
                    <h5 class="d-flex align-items-center" style="margin-bottom: 0;font-size: 1.125rem;"><button onclick='location.href="/panel/admin/admins"' class="btn_back d-flex align-items-center"><img src="/public/img/admin/ico_back.png" alt="" style="width:0.5rem;height:0.8125rem;vertical-align: -1px;"></button>ADMINS</h5>
              </div>
                <div class="card-block">
                    <div class="row">
                    <form class="container-fluid p-t-b p-r-l" action="/api/edit/admin" method="POST">
                        <div class="row" style="margin-bottom:15px;">
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <div class="col form-group">
                                    ...
                                    <input maxlength="20"  type="text" name="name" class="form-control addon check_letter"  style="text-transform: capitalize" placeholder="Name" required value="{{$data['name']}}">
                                </div>
                                <div class="col form-group">
                                    ...
                                    <input maxlength="40" type="email" name="email" class="form-control addon" placeholder="Email" required value="{{$data['email']}}">
                                </div>
                                <div class="col form-group">
                                    ...
                                    <input type="password" name="password" placeholder="New password"  class="form-control addon">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6 col-xl-6">
                            <input type="hidden" value="{{$token}}" name="token">
                                ...
                                <input type="hidden" name="admins_id" value="{{$data['id']}}">
                                <div class="col form-group">
                                    <span class="ico_input text-center"><i class="fa fa-lock" aria-hidden="true" style="color: #aab4bc;font-size: 1.3rem;margin-top: 1.1rem;"></i></span>
                                    <input type="password" name="password_confirm" placeholder="New password confirm" class="form-control addon">
                                </div>
                        </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row" style="margin: 15px 0 25px 0">
                            <div class="col-12 text-center">
                                <input type="submit" class="btn_page btn_submit" value="Edit">
                            </div>
                        </div>
                    </form>
                </div>
